<?php
// Inclusie van de vereiste bestanden (system.php, html.php, common.php)
require('system.php');
require('html.php');
require('common.php');
...
function do_student() {
	...
	while ($row = mysqli_fetch_assoc($uren)) {
	        ...
	        // Genereer HTML voor radio buttons voor inschrijvingen
	        $select3 .= <<<EOS
		...
		EOS;
	        ...
	        // Genereer HTML voor checkboxes voor vergrendelingen
	        if (!check_su()) {
	            	$select2 .= <<<EOS
		...
		EOJ;
	        ...
	        // Genereer HTML voor inschrijvingen
	        $select .= <<<EOS
			, IFNULL(
	    		CONCAT(
